...
case '18+menu':
totalChat = await KirBotz.chats.all()
groups = zafibotz.chats.array.filter(v => v.jid.endsWith('g.us'))
privat = zafibotz.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
thu = await zafibotz.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
menuh = `${ucapanWaktu} 𝐊𝐚𝐤 @${sender.split('@')[0]}`
KirBotz.sendMessage(from, { contentText: `${menuh}`, 
footerText: `*╭──「 18+ MENU 」*
*✗⃝* ${prefix}waifu
...
case 'dare':
              ...
              imageMsg = (await zafibotz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Donasi Ya Kak ☕', imageMessage: imageMsg,
              contentText:'*Dare*\n\n'+ der,buttons,headerType:4}
              prep = await zafibotz.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgi})
...
case 'nsfw_avatar':
                ...
                sendButImage(from, `RANDOM`, `Zafibotz c٥ʷₚͦ៰ᷜ⍳٥ˢ`, hasil, but)
                    break
case 'wasted':
		    var imgbb = require('imgbb-uploader')
...
if ((args[0]) == 'panjang'){
            ...
            zafibotz.sendMessage(from, buttonMessageo, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6287705048235@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `©KirBotz`, 'jpegThumbnail': fs.readFileSync('./V4/fakeakira.jpeg')}}}})
            }
            break
case 'payment':
...
if ((args[0]) == 'payment'){
            ...
            KirBotz.sendMessage(from, buttonMessageo, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6287705048235@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `©ZafiBotz`, 'jpegThumbnail': fs.readFileSync('./V4/fakeakira.jpeg')}}}})
